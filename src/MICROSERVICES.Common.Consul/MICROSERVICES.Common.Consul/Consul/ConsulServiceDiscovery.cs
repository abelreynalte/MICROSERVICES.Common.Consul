...
{
    public class ConsulServiceDiscovery : DelegatingHandler
    {
        ...
        public ConsulServiceDiscovery(IConsulServicesRegistry servicesRegistry,
            ...
            string serviceName, Uri uri)
        {
            ...
            if (service == null)
            {
                throw new ConsulNotFoundException($"Consul service: '{serviceName}' was not found.",
                    serviceName);
            }
